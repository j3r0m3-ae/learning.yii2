...
/**
 * Class m190719_140210_add_columns_to_user_table
 */
class m190719_140210_add_columns_to_user_table extends Migration
{

    public function up()
    {
        $this->addColumn('{{%user}}', 'about', $this->text());
        $this->addColumn('{{%user}}', 'type', $this->tinyInteger()->unsigned());
